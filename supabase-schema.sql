...
-- ============================================
-- COMBAT MVP (Phase 6.4-lite — Wanderer)
-- ============================================
-- Plan of record: ~/.claude/plans/ok-catch-me-up-polished-sedgewick.md
-- Lite single-archetype build. Multi-character migration is deferred to
-- Phase 6.4-full next Sunday. AP rides on the existing single-character
-- `character_stats` row; the eventual `characters` table will replace this.
...
-- A persistent enemy / boss campaign. One active boss per user for the lite build.
...
-- Log of combat actions (for telemetry + future replay)
